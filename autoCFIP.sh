...
auth_email="houniaollq@outlook.com"    #你的CloudFlare注册账户邮箱
auth_key="82326da5c050966bf89c561861258fea71e03"   #你的CloudFlare账户key,位置在域名概述页面点击右下角获取api key。
zone_name="houniao.top"     #你的主域名
record_name="dxcf"    #自动更新的二级域名前缀,例如cloudflare的cdn用cl，gcore的cdn用gcore，后面是数字，程序会自动添加。二级域名需要已经在域名管理网站配置完成，视频教程可以参考：https://www.youtube.com/channel/UCfSvDIQ8D_Zz62oAd5mcDDg
